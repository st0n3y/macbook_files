	...
	*/
	...
	if( !function_exists('gdlr_add_import_action') ){
		function gdlr_add_import_action(){
			...
			update_option( 'page_on_front', 1802 );
	...
	//$widget_data = array();
	//$widget_list = array('sidebars_widgets', 'widget_archives', 'widget_best_sellers', 'widget_calendar', 
	//	'widget_categories', 'widget_featured-products', 'widget_gdlr-flickr-widget', 
	//	'widget_gdlr-popular-post-widget', 'widget_gdlr-port-slider-widget', 
	//	'widget_gdlr-post-slider-widget', 'widget_gdlr-recent-portfolio-widget', 
	//	'widget_gdlr-recent-portfolio2-widget', 'widget_gdlr-recent-post-widget', 
	//	'widget_gdlr-twitter-widget', 'widget_gdlr-video-widget', 'widget_meta', 'widget_nav_menu', 
	...
	//	'widget_recently_viewed_products', 'widget_recent_reviews', 'widget_rss', 'widget_search', 
	//	'widget_shopping_cart', 'widget_tag_cloud', 'widget_text', 'widget_top-rated-products', 
	//	'widget_woocommerce_layered_nav', 'widget_woocommerce_layered_nav_filters', 
	//	'widget_woocommerce_random_products');
