	...
	<div class="sf-mega">
		<div class="sf-mega-section gdlr-woocommerce-cart">
			<div class="sub-menu-item">
				<?php 
					echo '<span class="head"><i class="fa ' . gdlr_fa_class('icon-shopping-cart') . '"></i>' . __('Items:', 'gdlr_translate') . ' </span>';
					echo '<span class="gdlr-cart-item-count">' . $woocommerce->cart->cart_contents_count . '</span>'; 
				?>
			</div>
			<div class="sub-menu-item">
				<?php
					echo '<span class="head"><i class="fa ' . gdlr_fa_class('icon-money') . '"></i>' . __('Subtotal:', 'gdlr_translate') . ' </span>';
