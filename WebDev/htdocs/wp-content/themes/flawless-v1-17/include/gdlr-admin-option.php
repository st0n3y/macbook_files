							...
							'options' => array(
								...
								'top-bar' => array(
									...
									'options' => array(
										...
										'top-bar-login' => array(
											'title' => __('Top Bar Login', 'gdlr_translate'),
											'type' => 'checkbox',									
										),
										'top-bar-subscribtion' => array(
											'title' => __('Top Bar Subscribtion', 'gdlr_translate'),
											'type' => 'textarea',	
											'description' => __('Place the shortcode from \'Easy MailChimp Forms\' plugin here', 'gdlr_translate')
										),
									)
								),
								...
								'header-logo' => array(
									...
									'options' => array(
										'header-style' => array(
											...
											'type' => 'combobox',
											'options' => array(
												'style-1'=> __('Header Style 1', 'gdlr_translate'),
												'style-2'=> __('Header Style 2', 'gdlr_translate'),
												'style-2 gdlr-centered'=> __('Header Style 2 (Centered)', 'gdlr_translate'),
											)
										),	
										...
										'logo-right-text-top-margin' => array(
											'title' => __('Right Text Top Margin', 'gdlr_translate'),
											'type' => 'text',
											'default' => '34',
											'selector' => '.gdlr-logo-right-text{ margin-top: #gdlr#; }',
											'data-type' => 'pixel',
											'wrapper-class' => 'header-style-wrapper style-2-wrapper'
										),
										'right-text' => array(
											'title' => __('Right Text', 'gdlr_translate'),
											'type' => 'textarea',
											'wrapper-class' => 'header-style-wrapper style-2-wrapper'
										),					
						...
						'elements-color' => array(
							...
							'options' => array(
								...
								'top-bar-color' => array(
									...
									'options' => array(
										'top-bar-top-border-color' => array(
											'title' => __('Top Bar Top Border', 'gdlr_translate'),
											'type' => 'colorpicker',
											'default' => '#1b1b1b',
											'selector'=> 'body .top-navigation-wrapper{ border-top-color: #gdlr#; }'
										),
										'top-bar-bottom-border-color' => array(
											'title' => __('Top Bar Bottom Border', 'gdlr_translate'),
											'type' => 'colorpicker',
											'default' => '#353535',
											'selector'=> '.top-navigation-wrapper, .gdlr-top-menu.sf-menu > li > a{ border-color: #gdlr#; }'
										),							
										...
										'top-bar-left-background' => array(
											'title' => __('Top Bar Left Background', 'gdlr_translate'),
											'type' => 'colorpicker',
											'default' => '#464646',
											'selector'=> '.gdlr-top-menu.sf-menu > li > a{ background-color: #gdlr#; }'
										),	
										'top-bar-left-text-color' => array(
											'title' => __('Top Bar Left Text', 'gdlr_translate'),
											'type' => 'colorpicker',
											'default' => '#ffffff',
											'selector'=> '.gdlr-top-menu.sf-menu > li > a{ color: #gdlr#; }'
										),
										'top-bar-left-submenu-background' => array(
											'title' => __('Top Bar Left Submenu Background', 'gdlr_translate'),
											'type' => 'colorpicker',
											'default' => '#ffffff',
											'selector'=> '.gdlr-top-menu > .gdlr-mega-menu .sf-mega{ background-color: #gdlr#; }'
										),
										'top-bar-left-submenu-text' => array(
											'title' => __('Top Bar Left Submenu Text', 'gdlr_translate'),
											'type' => 'colorpicker',
											'default' => '#808080',
											'selector'=> '.gdlr-top-menu > .gdlr-mega-menu .sf-mega, .gdlr-top-menu > .gdlr-mega-menu .sf-mega a{ color: #gdlr#; }'
										),
										'top-bar-left-submenu-border' => array(
											'title' => __('Top Bar Left Submenu Border', 'gdlr_translate'),
											'type' => 'colorpicker',
											'default' => '#e3e3e3',
											'selector'=> '.gdlr-top-menu.sf-menu > li .sub-menu-item{ border-color: #gdlr#; }'
										),
								...
								'main-navigation-color' => array(
									...
									'options' => array(
										...
										'main-navigation2-background' => array(
											'title' => __('Main Navigation (Style 2) Background ', 'gdlr_translate'),
											'type' => 'colorpicker',
											'default' => '#f9f9f9',
											'selector'=> '.gdlr-navigation-wrapper.gdlr-style-2{ background-color: #gdlr#; }'
										),
										'main-navigation2-top-border' => array(
											'title' => __('Main Navigation (Style 2) Top Border ', 'gdlr_translate'),
											'type' => 'colorpicker',
											'default' => '#ececec',
											'selector'=> '.gdlr-navigation-wrapper.gdlr-style-2{ border-top-color: #gdlr#; }'
										),
										'main-navigation2-slide-bar' => array(
											'title' => __('Main Navigation (Style 2) Slide Bar ', 'gdlr_translate'),
											'type' => 'colorpicker',
											'default' => '#bbbbbb',
											'selector'=> '.gdlr-navigation-wrapper.gdlr-style-2 .gdlr-navigation-slide-bar{ background-color: #gdlr#; }'
										),
								...
								'body-color' => array(
									...
									'options' => array(
										...
										'container-backgrond' => array(
											...
											'type' => 'colorpicker',
											'default' => '#ffffff',
											'selector'=> '.body-wrapper, .gdlr-fixed-menu{ background-color: #gdlr#; }'
										),	
								...
								'portfolio-color' => array(
									...
									'options' => array(
										...
										'portfolio-thumbnail-hover-icon-background' => array(
											...
											'default' => '#545454',
											'selector'=> '.gdlr-image-link-shortcode .gdlr-image-link-icon, ' .
												'.portfolio-thumbnail .portfolio-icon{ background-color: #gdlr#; }'
										),	
										...
										'classic-portfolio-bottom-bar' => array(
											'title' => __('Classic Portfolio Bottom Bar', 'gdlr_translate'),
											'type' => 'colorpicker',
											'default' => '#99d15e',
											'selector'=> '.portfolio-thumbnail-bar{ background-color: #gdlr#; }'
										),
										'modern-portfolio-title-background' => array(
											'title' => __('Modern Portfolio Title Background', 'gdlr_translate'),
											'type' => 'colorpicker',
											'default' => '#000000',
											'selector'=> '.gdlr-modern-portfolio .portfolio-content-overlay{ background-color: #gdlr#; }'
										),			
								...
								'slider-input-color' => array(
									...
									'options' => array(
										...
										'slider-outer-navigation-background' => array(
											'title' => __('Slider Outer Navigation Background', 'gdlr_translate'),
											'type' => 'colorpicker',
											'default' => '#f7f7f7',
											'selector'=> '.nav-container.style-1 .flex-direction-nav a{ background-color: #gdlr#; }',
										...
										'slider-outer-navigation-icon' => array(
											...
											'type' => 'colorpicker',
											'default' => '#8e8e8e',
											'selector'=> '.nav-container.style-1 .flex-direction-nav a{ color: #gdlr#; }'
										),										
