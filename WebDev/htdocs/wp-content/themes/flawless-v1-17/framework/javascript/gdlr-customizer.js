...
var color_option = [
{name: "top-bar-top-border-color", selector: "body .top-navigation-wrapper{ border-top-color: #gdlr#; }"},
{name: "top-bar-bottom-border-color", selector: ".top-navigation-wrapper, .gdlr-top-menu.sf-menu > li > a{ border-color: #gdlr#; }"},
...
{name: "top-bar-left-background", selector: ".gdlr-top-menu.sf-menu > li > a{ background-color: #gdlr#; }"},
{name: "top-bar-left-text-color", selector: ".gdlr-top-menu.sf-menu > li > a{ color: #gdlr#; }"},
{name: "top-bar-left-submenu-background", selector: ".gdlr-top-menu > .gdlr-mega-menu .sf-mega{ background-color: #gdlr#; }"},
{name: "top-bar-left-submenu-text", selector: ".gdlr-top-menu > .gdlr-mega-menu .sf-mega, .gdlr-top-menu > .gdlr-mega-menu .sf-mega a{ color: #gdlr#; }"},
{name: "top-bar-left-submenu-border", selector: ".gdlr-top-menu.sf-menu > li .sub-menu-item{ border-color: #gdlr#; }"},
...
{name: "main-navigation2-background", selector: ".gdlr-navigation-wrapper.gdlr-style-2{ background-color: #gdlr#; }"},
{name: "main-navigation2-top-border", selector: ".gdlr-navigation-wrapper.gdlr-style-2{ border-top-color: #gdlr#; }"},
{name: "main-navigation2-slide-bar", selector: ".gdlr-navigation-wrapper.gdlr-style-2 .gdlr-navigation-slide-bar{ background-color: #gdlr#; }"},
...
{name: "menu-search-button-background", selector: ".gdlr-nav-search-form-button { background-color: #gdlr#; }"},
{name: "menu-search-button-icon", selector: ".gdlr-nav-search-form-button { color: #gdlr#; }"},
{name: "menu-search-button-border", selector: ".gdlr-nav-search-form-button { border-color: #gdlr#; }"},
...
{name: "container-backgrond", selector: ".body-wrapper, .gdlr-fixed-menu{ background-color: #gdlr#; }"},
...
{name: "button-background", selector: ".gdlr-button, .gdlr-button:hover, input[type=\"button\"], input[type=\"submit\"]{ background-color: #gdlr#; }"},
...
{name: "button-border-color", selector: ".gdlr-button, input[type=\"button\"], input[type=\"submit\"]{ border-color: #gdlr#; }"},
{name: "column-service-title-color", selector: ".column-service-icon, .column-service-title{ color: #gdlr#; }"},
...
{name: "blog-info-color", selector: ".blog-info, .blog-info a, .comment-time, .comment-time a{ color: #gdlr#; }"},
{name: "blog-info-icon-color", selector: ".blog-info i, .comment-time i, .comment-reply i{ color: #gdlr#; }"},
...
{name: "portfolio-filter-button-background", selector: ".portfolio-item-filter a{ background-color: #gdlr#; }"},
{name: "portfolio-filter-button-text", selector: ".portfolio-item-filter a{ color: #gdlr#; }"},
{name: "portfolio-filter-button-background-hover", selector: ".portfolio-item-filter a:hover, .portfolio-item-filter a.active{ background-color: #gdlr#; }"},
{name: "portfolio-filter-button-text-hover", selector: ".portfolio-item-filter a:hover, .portfolio-item-filter a.active{ color: #gdlr#; }"},
...
{name: "portfolio-thumbnail-hover-icon-background", selector: ".gdlr-image-link-shortcode .gdlr-image-link-icon, .portfolio-thumbnail .portfolio-icon{ background-color: #gdlr#; }"},
...
{name: "classic-portfolio-bottom-bar", selector: ".portfolio-thumbnail-bar{ background-color: #gdlr#; }"},
{name: "modern-portfolio-title-background", selector: ".gdlr-modern-portfolio .portfolio-content-overlay{ background-color: #gdlr#; }"},
...
{name: "slider-outer-navigation-background", selector: ".nav-container.style-1 .flex-direction-nav a{ background-color: #gdlr#; }"},
{name: "slider-outer-navigation-icon", selector: ".nav-container.style-1 .flex-direction-nav a{ color: #gdlr#; }"},
{name: "input-box-background", selector: "input[type=\"text\"], input[type=\"email\"], input[type=\"password\"], textarea{ background-color: #gdlr#; }"},
{name: "input-box-text", selector: "input[type=\"text\"], input[type=\"email\"], input[type=\"password\"], textarea{ color: #gdlr#; }"},
{name: "footer-top-border-color", selector: ".footer-wrapper{ border-top-color: #gdlr#; }"},
