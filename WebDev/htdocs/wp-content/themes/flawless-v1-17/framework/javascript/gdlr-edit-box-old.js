(function($){
	...
	$.fn.gdlrEditBoxTinyMCE = function( option ){	
		...
		current_tinymce = $('<div class="gdlr-tinymce wp-core-ui wp-editor-wrap tmce-active" data-id="' + tinymce_id + '" >\
							...
							<a class="wp-switch-editor switch-html" onclick="switchEditors.switchto(this);">Text</a>\
							<a class="wp-switch-editor switch-tmce" onclick="switchEditors.switchto(this);">Visual</a>\
							...
							<div id="wp-gdlr-editor-content-editor-container" class="wp-editor-container">\
							<textarea class="wp-editor-area" rows="20" cols="40" name="' + option.attr('data-name') + '" id="' + tinymce_id + '">' + value + '</textarea>\
							</div>\
							</div>');
