	...
	if( !function_exists('gdlr_register_portfolio_item') ){
		function gdlr_register_portfolio_item( $page_builder = array() ){
			...
			$page_builder['content-item']['options']['portfolio'] = array(
				...
				'options'=>array(		
					'title-type'=> array(	
						'title'=> __('Title Type' ,'gdlr-portfolio'),
						'type'=> 'combobox',
						'options'=> array(
							'none'=> __('None' ,'gdlr-portfolio'),
							'left'=> __('Left Align With Caption' ,'gdlr-portfolio'),
							'center'=> __('Center Align With Caption' ,'gdlr-portfolio'),
							'no-caption'=> __('Left Align No Caption' ,'gdlr-portfolio')
						)
					),										
					'title'=> array(	
					...
					'caption'=> array(	
						'title'=> __('Caption' ,'gdlr-portfolio'),
						'type'=> 'textarea',
						'wrapper-class'=>'title-type-wrapper left-wrapper center-wrapper'
					),	
					'right-text'=> array(	
						'title'=> __('Titlte Right Text' ,'gdlr-portfolio'),
						'type'=> 'text',
						'default'=> __('View All Works', 'gdlr-portfolio'),
						'wrapper-class'=>'title-type-wrapper left-wrapper center-wrapper no-caption-wrapper'
					),	
					'right-text-link'=> array(	
						'title'=> __('Title Right Text Link' ,'gdlr-portfolio'),
						'type'=> 'text',
						'wrapper-class'=>'title-type-wrapper left-wrapper center-wrapper no-caption-wrapper'
					),					
					'category'=> array(
					...
					'portfolio-style'=> array(
						...
						'type'=> 'combobox',
						'options'=> array(
							'classic-portfolio' => __('Portfolio Classic Style', 'gdlr-portfolio'),
							'modern-portfolio' => __('Portfolio Modern Style', 'gdlr-portfolio'),
							'detail-portfolio' => __('Portfolio With Detail', 'gdlr-portfolio'),
						),
					),						
					'num-excerpt'=> array(
						'title'=> __('Num Excerpt (Word)' ,'gdlr-portfolio'),
						'type'=> 'text',	
						'default'=> '25',
						'wrapper-class'=> 'detail-portfolio-wrapper portfolio-style-wrapper',
						'description'=> __('This is a number of word (decided by spaces) that you want to show on the post excerpt. <strong>Use 0 to hide the excerpt, -1 to show full posts and use the wordpress more tag</strong>.', 'gdlr-portfolio')
					),	
					'num-fetch'=> array(
					...
					'portfolio-size'=> array(
						...
						'default'=>'1/3',
						'wrapper-class'=> 'classic-portfolio-wrapper modern-portfolio-wrapper portfolio-style-wrapper'
					),					
					...
					'portfolio-filter'=> array(
						...
						'type'=> 'checkbox',
						'default'=> 'disable',
						'description'=> __('*** You have to select only 1 ( or none ) portfolio category when enable this option','gdlr-portfolio')
					),						
